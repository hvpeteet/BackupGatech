...
double compute_emat() {
    ...
    long int total_time = count_tlbhits * MEMORY_ACCESS_TIME + tlb_misses * 2 * MEMORY_ACCESS_TIME + count_pagefaults * DISK_ACCESS_TIME;
    double emat = ((double) total_time) / total_accesses;
    return emat;
}
